...
import { getPreviewMap, spawnParticle } from '@coilbox/core/Particles/System/ParticlePreviewRegistry'
import Grass from '@coilbox/core/Prefab/Grass/Grass'
import { LIGHT_REGISTRY } from '@coilbox/core/Prefab/Lights/index'
import { PRIMITIVE_REGISTRY } from '@coilbox/core/Prefab/Primitives/index'
import Water from '@coilbox/core/Prefab/Water/Water'
import WaterManager from '@coilbox/core/Prefab/Water/WaterManager'
import AssetRenderer from '@coilbox/core/Renderer/AssetRenderer'
...
export default () => {
  ...
  const DRAG_MIME = 'application/coilbox-resource'
  const PREFAB_DRAG_MIME = 'application/coilbox-prefab'
  const PARTICLE_DRAG_MIME = 'application/coilbox-particle'
  const PRIMITIVE_DRAG_MIME = 'application/coilbox-primitive'
  const LIGHT_DRAG_MIME = 'application/coilbox-light'
